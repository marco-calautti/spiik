...
EXPORT_DECL(int, MCP_GetSysProdSettings, int IOHandle, struct MCPSysProdSettings * settings);
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
//! UC functions
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
EXPORT_DECL(int, UCReadSysConfig, int IOHandle, int count, struct UCSysConfig * settings);
...
void InitOSFunctionPointers(void)
{
    ...
    OS_FIND_EXPORT(coreinit_handle, MCP_GetSysProdSettings);
    ...
    //! UC functions
    //!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    OS_FIND_EXPORT(coreinit_handle, UCReadSysConfig);
