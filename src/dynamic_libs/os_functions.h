...
/* structures for coreinit */
struct UCSysConfig
{
   char name[32];
   char unknown[32];
   int unk1; // access rights? 0x777
   int dataType;
   int unk3; // usually 0x00?
   int dataSize;
   void* data;
};
...
extern int (* MCP_GetSysProdSettings)(int IOHandle, struct MCPSysProdSettings * settings);
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//! LOADER functions
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
//! UC functions
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
extern int (* UCReadSysConfig)(int IOHandle, int count, struct UCSysConfig * settings);
